...
import com.restu.mvvmcleanapplication.databinding.ListItemBinding
...
RecyclerView.ViewHolder(binding.root){
   ...
   fun bind(movie:Movie){
        ...
        binding.overviewRow.text = movie.overview
        val posterURL = "https://image.tmdb.org/t/p/w500"+movie.posterPath
        Glide.with(binding.imageRow.context)
            .load(posterURL)
            .into(binding.imageRow)
       binding.dateRow.text = movie.releaseDate
